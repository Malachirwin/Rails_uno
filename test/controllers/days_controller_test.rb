...
class DaysControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create day" do
    assert_difference('Day.count') do
      post days_url, params: { day: { location: @day.location, total_dozens_sold: @day.total_dozens_sold, total_profit: @day.total_profit } }
    end
  ...
  test "should update day" do
    patch day_url(@day), params: { day: { location: @day.location, total_dozens_sold: @day.total_dozens_sold, total_profit: @day.total_profit } }
